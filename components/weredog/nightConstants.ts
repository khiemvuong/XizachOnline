...
export const ROLE_DISPLAY: Record<WeredogRoleName, RoleDisplayConfig> = {
  Wolf: {
    ...
    actionHeading: "MA SÓI ĐANG ĐI SĂN",
  ...
  Bodyguard: {
    ...
    actionHeading: "BẢO VỆ ĐANG CANH GÁC",
  ...
  Seer: {
    ...
    actionHeading: "TIÊN TRI ĐANG SOI THẺ",
  ...
  Hunter: {
    ...
    actionHeading: "THỢ SĂN ĐANG NGẮM BẮN",
  ...
  Cupid: {
    ...
    actionHeading: "CUPID ĐANG XE DUYÊN",
  ...
  Witch: {
    ...
    actionHeading: "PHÙ THỦY ĐANG DÙNG THUỐC",
  ...
  Elder: {
    ...
    actionHeading: "GIÀ LÀNG ĐANG NGỦ",
    confirmLabel: "",
