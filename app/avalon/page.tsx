...
export default function AvalonHome() {
  ...
  return (
    <div className="avalon-home-shell avalon-theme min-h-dvh overflow-y-auto flex items-center justify-center p-4">
      <div 
      ...
      >
        ...
        <div className="avalon-home-actions flex flex-col gap-6">
          <button 
            ...
            className="avalon-home-btn w-full p-4 text-surface-dim-avalon font-bold transition-transform active:scale-95 text-lg shadow-lg uppercase tracking-wider"
          ...
          <form onSubmit={handleJoin} className="flex flex-col gap-4">
            <input
              ...
              className="avalon-home-input p-4 border focus:outline-none focus:ring-1 text-xl font-bold text-center uppercase tracking-widest placeholder:tracking-normal placeholder:font-normal bg-transparent"
              style={{ borderColor: 'var(--outline-variant)', color: 'var(--on-surface)', borderRadius: '2px' }}
              required
            />
            <button 
              type="submit" 
              className="avalon-home-btn w-full p-4 text-secondary-avalon font-bold transition-transform active:scale-95 text-lg shadow-lg uppercase tracking-wider border"
